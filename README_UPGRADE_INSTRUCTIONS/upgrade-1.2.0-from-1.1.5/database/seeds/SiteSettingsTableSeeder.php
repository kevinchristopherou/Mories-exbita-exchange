...
class SiteSettingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $this->set('SOCIAL_FACEBOOK_URL', 'Facebook Url', 'Facebook Url (Please enter full url including http:// prefix)', 'text');
        $this->set('SOCIAL_TWITTER_URL', 'Twitter Url', 'Twitter Url (Please enter full url including http:// prefix )', 'text');
    ...
    public function set($name, $label, $description, $type, $value = '', $sensitive = false, $skipSeeder = false)
    {
        ...
        if($type !== 'image' && $type !== 'file' && !$skipSeeder && ($name != 'KYC_STATE')) {
